...
namespace Week_2
{
    ...
    {
        public static Employee FindMax(Employee[] emp) 
        {
            //var max = emp[0];
            ...
            return emp.ToList().OrderByDescending(e => e.Age).ToArray()[0];
        }
        public static void Main()
        {
            ...
            var empMax = FindMax(empArray);
            Console.WriteLine($"MAX AGE: {empMax.Id} {empMax.FirstName} {empMax.LastName} {empMax.Age}");
        }
    }
}